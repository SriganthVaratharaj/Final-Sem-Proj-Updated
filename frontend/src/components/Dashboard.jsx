...
export default function Dashboard() {
  ...
  const totalInvoices = successDocs.length
  
  // Calculate total expense
  const totalExpense = successDocs.reduce((acc, doc) => {
  ...
  // Sort months chronologically (rough sorting)
    ...
    <div className="space-y-8 animate-fade-in pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="glass p-5 flex flex-col justify-between">
          ...
          <span className="text-xs text-gray-500 mt-2">Aggregated from all verified extractions</span>
        </div>
        ...
        <div className="glass p-5 flex flex-col justify-between">
          ...
          <span className="text-xs text-green-600 mt-2 font-medium">✓ 100% database consistency</span>
        </div>
        ...
        <div className="glass p-5 flex flex-col justify-between">
          ...
          <span className="text-xs text-gray-500 mt-2">Highest single merchant spending share</span>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="glass p-5 space-y-4">
            ...
            {monthlySpending.length === 0 ? (
              <div className="h-48 flex items-center justify-center text-xs text-gray-400 italic">No spending data logged.</div>
            ) : (
          ...
          <div className="glass p-5 space-y-4">
            <div>
              ...
              <p className="text-[11px] text-gray-500 mt-0.5">Primary merchants contributing to overall expenses</p>
            </div>
            {topVendors.length === 0 ? (
                  ...
                  return (
                    <div key={idx} className="space-y-1">
                      <div className="flex justify-between text-xs font-semibold text-gray-800">
                        <span className="truncate max-w-[70%]">{vendor.name}</span>
